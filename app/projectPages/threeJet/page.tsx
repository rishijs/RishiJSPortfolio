...
export default function Page() {
  return (
    <section className="grid grid-cols-1 gap-2">
      ...
      <a className="text-sm tracking-tighter">This is my legacy 3D portfolio, and it was made with three.js</a>
      <Link
      ...
      <Image aria-hidden src="/projectpictures/threeJet/threejet.png" className="w-full aspect-video self-stretch" alt="threeJet" width={256} height={144} />
