          ...
          >
            <div className="group flex flex-col w-full border-b border-neutral-200 dark:border-neutral-800 py-2 transition-all hover:border-red-500 last:border-0">
              <div className="flex items-center justify-between w-full flex-wrap gap-2">
                <h2 className="title font-bold text-xl tracking-tighter group-hover:text-red-500 transition-colors">
                  {post.metadata.title}
                </h2>
                <p className="text-xs font-mono text-neutral-500 dark:text-neutral-400 whitespace-nowrap">
